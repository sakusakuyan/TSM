...
public class JdbcTest {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/SchoolManagement?useUnicode=true&characterEncoding=UTF-8";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "202401220064";
